...
/** 色海主 feed：按行优先排列，宽屏增加列数以铺满 */
export const COLOR_SEA_MASONRY_CLASS =
  'grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6';

/** 色海顶部精选区（与主 feed 列数一致） */
export const COLOR_SEA_FEATURED_GRID_CLASS =
  'grid w-full grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 sm:gap-2.5';
